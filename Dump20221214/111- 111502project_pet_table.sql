...
CREATE TABLE `pet_table` (
  ...
  `pet_sexual` char(2) NOT NULL,
  `pet_ligation` char(2) NOT NULL,
...
INSERT INTO `pet_table` VALUES ('U000001','Tommy','狗','母','是','toy poodle',1,NULL),('U000002','Yoru','貓','公','否','Persian cat',2,NULL);
...
-- Dump completed on 2022-12-14 21:20:49
